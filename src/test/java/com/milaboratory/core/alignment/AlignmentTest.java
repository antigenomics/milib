...
public class AlignmentTest extends AbstractAlignmentTest {
    @Test
    ...
    public void testAlignmentElements1() {
        ...
        Alignment<NucleotideSequence> alignment =
                new Alignment<>(
                        sequence1,
                        Mutations.decode("DG4:SA7T:ST8G:I9T:I9A:I9T", NucleotideSequence.ALPHABET),
                        new Range(2, 10), new Range(1, 11),
                        0);
        Assert.assertEquals("1S2N2=1I2=2X3D1=", alignment.getCigarString(true));

        alignment =
                new Alignment<>(
                        sequence1,
                        Mutations.decode("DG4:I6T", NucleotideSequence.ALPHABET),
                        new Range(2, 9), new Range(1, 8),
                        0);
        Assert.assertEquals("1S2N2=1I1=1D3=", alignment.getCigarString(true));
        ...
        alignment = new Alignment<>(
                ...
                0);
        Assert.assertEquals("2N2=2I1D3=", alignment.getCigarString(true));

        alignment = new Alignment<>(
                sequence1,
                Mutations.decode("DG4:SC5G:I6T", NucleotideSequence.ALPHABET),
                new Range(2, 9), new Range(7, 14),
                0);
        Assert.assertEquals("7S2N2=1I1X1D3=", alignment.getCigarString(true));
        ...
        alignment = new Alignment<>(
                ...
                0);
        Assert.assertEquals("2N2D2=1I1X1D3=", alignment.getCigarString(true));
        ...
        alignment = new Alignment<>(
                ...
                new Range(2, 9), new Range(0, 9),
                0);
        Assert.assertEquals("2N1=2D1=1I1X1D3=", alignment.getCigarString(true));
        ...
        alignment = new Alignment<>(
                ...
                new Range(2, 9), new Range(0, 9),
                0);
        Assert.assertEquals("2N2=1I1X1D3=2D", alignment.getCigarString(true));

        alignment = new Alignment<>(
                sequence1,
                Mutations.decode("DG4:SC5G:I6T:I9A:I9T", NucleotideSequence.ALPHABET),
                new Range(0, 9), new Range(0, 11),
                0);
        Assert.assertEquals("4=1I1X1D3=2D", alignment.getCigarString(true));
