    ...
    public void testRandom1() throws Exception {
        ...
        for (AlignmentScoring<NucleotideSequence> scoring : scorings) {
            ...
            for (int i = 0; i < 10000; i++) {
                ...
                AlignmentTestUtils.assertAlignment(al0, seq2, scoring);

                Alignment al0LTrimmed = AlignmentTrimmer.leftTrimAlignment(al0, scoring);
                AlignmentTestUtils.assertAlignment(al0LTrimmed, seq2, scoring);
                ...
                AlignmentTestUtils.assertAlignment(al0RTrimmed, seq2, scoring);
