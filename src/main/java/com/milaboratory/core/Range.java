...
public final class Range implements java.io.Serializable, Comparable<Range> {
    ...
    /**
     * Returns a new range object with the edge values moved by the corresponding offset
     *
     * @param lowerValueOffset lower value offset
     * @param upperValueOffset upper value offset
     * @return new range with the edge values moved by the corresponding offset
     */
    public Range offset(int lowerValueOffset, int upperValueOffset) {
        if (lowerValueOffset == 0 && upperValueOffset == 0)
            return this;
        return new Range(lower + lowerValueOffset, upper + upperValueOffset, reversed);
    }
